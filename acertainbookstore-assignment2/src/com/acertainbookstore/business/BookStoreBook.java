...
//			System.out.println("[buy books]before: " + this.numCopies);
			this.numCopies -= numCopies;
//			System.out.println("[buy books]after: " + this.numCopies);
			return true;
		}
...
//			System.out.println("[add copies]before: " + this.numCopies);
			this.numCopies += numNewCopies;
//			System.out.println("[add copies]after: " + this.numCopies);
...
//		System.out.println("[add sale misses]before: " + this.numSaleMisses);
		this.numSaleMisses += numSaleMisses;
//		System.out.println("[add sale misses]after: " + this.numSaleMisses);
	}
