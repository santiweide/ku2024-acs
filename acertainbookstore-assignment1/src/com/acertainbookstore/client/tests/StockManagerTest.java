...
public class StockManagerTest {
	...
	/**
	 * Tests getting books in demand.
	 *
	 * @throws BookStoreException the book store exception
	 */
	@Test
	public void testGetBooksInDemand() throws BookStoreException {
		// Add a few books to the store with different demand levels
		StockBook book1 = new ImmutableStockBook(TEST_ISBN + 1, "The Art of Computer Programming", "Donald Knuth", (float) 300, NUM_COPIES, 10, 5, 0, false);
		StockBook book2 = new ImmutableStockBook(TEST_ISBN + 2, "The C Programming Language", "Dennis Ritchie", (float) 50, NUM_COPIES, 50, 20, 0, false);
		StockBook book3 = new ImmutableStockBook(TEST_ISBN + 3, "Introduction to Algorithms", "Thomas H. Cormen", (float) 75, NUM_COPIES, 2, 1, 0, false);
		...
		assertEquals(3, booksInDemand.size());
		assertTrue(booksInDemand.get(0).equals(book3)); // book2 should be the most in demand
		assertTrue(booksInDemand.get(1).equals(book2)); // book1 should follow
		assertTrue(booksInDemand.get(2).equals(book1)); // book3 should be last in demand
	}
